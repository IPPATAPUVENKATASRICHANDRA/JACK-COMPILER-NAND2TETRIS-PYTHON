...
class CompilationEngine:
    ...
    def compile_class_var_dec(self, tokenizer=None): 
        # Method for compiling class variable declarations (static and field).
    ...
    def compile_subroutine_dec(self, tokenizer=None):
        # Method for compiling subroutine declarations (constructor, function, and method).
    ...
    def compile_parameter_list(self, tokenizer=None):
       # Method for compiling the parameter list of a subroutine.
